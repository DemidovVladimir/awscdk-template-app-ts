...
| <code><a href="#awscdk-template-app-ts.AwsCdkTemplateTypeScriptApp.tryRemoveFile">tryRemoveFile</a></code> | Finds a file at the specified relative path within this project and removes it. |
...
###### `task`<sup>Required</sup> <a name="task" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptApp.runTaskCommand.parameter.task"></a>
...
###### `deps`<sup>Required</sup> <a name="deps" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptApp.addDeps.parameter.deps"></a>
...
##### `addKeywords` <a name="addKeywords" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptApp.addKeywords"></a>
...
###### `modules`<sup>Required</sup> <a name="modules" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptApp.addCdkDependency.parameter.modules"></a>
...
###### `construct`<sup>Required</sup> <a name="construct" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptApp.of.parameter.construct"></a>
...
| <code><a href="#awscdk-template-app-ts.AwsCdkTemplateTypeScriptApp.property.allowLibraryDependencies">allowLibraryDependencies</a></code> | <code>boolean</code> | *No description.* |
...
| <code><a href="#awscdk-template-app-ts.AwsCdkTemplateTypeScriptApp.property.cdkConfig">cdkConfig</a></code> | <code>projen.awscdk.CdkConfig</code> | cdk.json configuration. |
...
##### `gitattributes`<sup>Required</sup> <a name="gitattributes" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptApp.property.gitattributes"></a>
...
##### `projenCommand`<sup>Required</sup> <a name="projenCommand" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptApp.property.projenCommand"></a>
...
##### `tsconfig`<sup>Optional</sup> <a name="tsconfig" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptApp.property.tsconfig"></a>
...
| <code><a href="#awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.allowLibraryDependencies">allowLibraryDependencies</a></code> | <code>boolean</code> | Allow the project to include `peerDependencies` and `bundledDependencies`. |
...
| <code><a href="#awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.repository">repository</a></code> | <code>string</code> | The repository is the location where the actual code for your package lives. |
...
| <code><a href="#awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.workflowRunsOn">workflowRunsOn</a></code> | <code>string[]</code> | Github Runner selection labels. |
...
| <code><a href="#awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.projenDevDependency">projenDevDependency</a></code> | <code>boolean</code> | Indicates of "projen" should be installed as a devDependency. |
...
| <code><a href="#awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.tsJestOptions">tsJestOptions</a></code> | <code>projen.typescript.TsJestOptions</code> | Options for ts-jest. |
...
| <code><a href="#awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.deployOptions">deployOptions</a></code> | <code><a href="#awscdk-template-app-ts.DeployOptions">DeployOptions</a></code> | Deployment options. |
...
##### `renovatebotOptions`<sup>Optional</sup> <a name="renovatebotOptions" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.renovatebotOptions"></a>
...
##### `autoApproveOptions`<sup>Optional</sup> <a name="autoApproveOptions" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.autoApproveOptions"></a>
...
##### `autoMerge`<sup>Optional</sup> <a name="autoMerge" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.autoMerge"></a>
...
##### `autoMergeOptions`<sup>Optional</sup> <a name="autoMergeOptions" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.autoMergeOptions"></a>
...
##### `clobber`<sup>Optional</sup> <a name="clobber" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.clobber"></a>
...
##### `devContainer`<sup>Optional</sup> <a name="devContainer" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.devContainer"></a>
...
##### `github`<sup>Optional</sup> <a name="github" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.github"></a>
...
##### `githubOptions`<sup>Optional</sup> <a name="githubOptions" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.githubOptions"></a>
...
##### `gitpod`<sup>Optional</sup> <a name="gitpod" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.gitpod"></a>
...
##### ~~`mergify`~~<sup>Optional</sup> <a name="mergify" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.mergify"></a>
...
##### ~~`mergifyOptions`~~<sup>Optional</sup> <a name="mergifyOptions" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.mergifyOptions"></a>
...
##### ~~`projectType`~~<sup>Optional</sup> <a name="projectType" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.projectType"></a>
...
##### `projenCredentials`<sup>Optional</sup> <a name="projenCredentials" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.projenCredentials"></a>
...
##### ~~`projenTokenSecret`~~<sup>Optional</sup> <a name="projenTokenSecret" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.projenTokenSecret"></a>
...
##### `readme`<sup>Optional</sup> <a name="readme" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.readme"></a>
...
##### `stale`<sup>Optional</sup> <a name="stale" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.stale"></a>
...
##### `staleOptions`<sup>Optional</sup> <a name="staleOptions" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.staleOptions"></a>
...
##### `vscode`<sup>Optional</sup> <a name="vscode" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.vscode"></a>
...
##### `allowLibraryDependencies`<sup>Optional</sup> <a name="allowLibraryDependencies" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.allowLibraryDependencies"></a>
...
##### `authorEmail`<sup>Optional</sup> <a name="authorEmail" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.authorEmail"></a>
...
##### `authorName`<sup>Optional</sup> <a name="authorName" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.authorName"></a>
...
##### `authorOrganization`<sup>Optional</sup> <a name="authorOrganization" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.authorOrganization"></a>
...
##### `authorUrl`<sup>Optional</sup> <a name="authorUrl" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.authorUrl"></a>
...
##### `autoDetectBin`<sup>Optional</sup> <a name="autoDetectBin" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.autoDetectBin"></a>
...
##### `bin`<sup>Optional</sup> <a name="bin" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.bin"></a>
...
##### `bugsEmail`<sup>Optional</sup> <a name="bugsEmail" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.bugsEmail"></a>
...
##### `bugsUrl`<sup>Optional</sup> <a name="bugsUrl" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.bugsUrl"></a>
...
##### `bundledDeps`<sup>Optional</sup> <a name="bundledDeps" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.bundledDeps"></a>
...
##### `codeArtifactOptions`<sup>Optional</sup> <a name="codeArtifactOptions" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.codeArtifactOptions"></a>
...
##### `deps`<sup>Optional</sup> <a name="deps" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.deps"></a>
...
##### `description`<sup>Optional</sup> <a name="description" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.description"></a>
...
##### `devDeps`<sup>Optional</sup> <a name="devDeps" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.devDeps"></a>
...
##### `entrypoint`<sup>Optional</sup> <a name="entrypoint" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.entrypoint"></a>
...
##### `homepage`<sup>Optional</sup> <a name="homepage" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.homepage"></a>
...
##### `keywords`<sup>Optional</sup> <a name="keywords" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.keywords"></a>
...
##### `license`<sup>Optional</sup> <a name="license" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.license"></a>
...
##### `licensed`<sup>Optional</sup> <a name="licensed" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.licensed"></a>
...
##### `maxNodeVersion`<sup>Optional</sup> <a name="maxNodeVersion" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.maxNodeVersion"></a>
...
##### `minNodeVersion`<sup>Optional</sup> <a name="minNodeVersion" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.minNodeVersion"></a>
...
##### `npmAccess`<sup>Optional</sup> <a name="npmAccess" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.npmAccess"></a>
...
##### ~~`npmRegistry`~~<sup>Optional</sup> <a name="npmRegistry" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.npmRegistry"></a>
...
##### `npmRegistryUrl`<sup>Optional</sup> <a name="npmRegistryUrl" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.npmRegistryUrl"></a>
...
##### `npmTokenSecret`<sup>Optional</sup> <a name="npmTokenSecret" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.npmTokenSecret"></a>
...
##### `packageManager`<sup>Optional</sup> <a name="packageManager" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.packageManager"></a>
...
##### `packageName`<sup>Optional</sup> <a name="packageName" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.packageName"></a>
...
##### `peerDependencyOptions`<sup>Optional</sup> <a name="peerDependencyOptions" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.peerDependencyOptions"></a>
...
##### `peerDeps`<sup>Optional</sup> <a name="peerDeps" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.peerDeps"></a>
...
##### `pnpmVersion`<sup>Optional</sup> <a name="pnpmVersion" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.pnpmVersion"></a>
...
##### `repository`<sup>Optional</sup> <a name="repository" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.repository"></a>
...
##### `repositoryDirectory`<sup>Optional</sup> <a name="repositoryDirectory" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.repositoryDirectory"></a>
...
##### `scopedPackagesOptions`<sup>Optional</sup> <a name="scopedPackagesOptions" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.scopedPackagesOptions"></a>
...
##### ~~`scripts`~~<sup>Optional</sup> <a name="scripts" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.scripts"></a>
...
##### `stability`<sup>Optional</sup> <a name="stability" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.stability"></a>
...
##### `yarnBerryOptions`<sup>Optional</sup> <a name="yarnBerryOptions" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.yarnBerryOptions"></a>
...
##### `jsiiReleaseVersion`<sup>Optional</sup> <a name="jsiiReleaseVersion" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.jsiiReleaseVersion"></a>
...
##### `majorVersion`<sup>Optional</sup> <a name="majorVersion" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.majorVersion"></a>
...
##### `minMajorVersion`<sup>Optional</sup> <a name="minMajorVersion" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.minMajorVersion"></a>
...
##### `npmDistTag`<sup>Optional</sup> <a name="npmDistTag" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.npmDistTag"></a>
...
##### `postBuildSteps`<sup>Optional</sup> <a name="postBuildSteps" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.postBuildSteps"></a>
...
##### `prerelease`<sup>Optional</sup> <a name="prerelease" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.prerelease"></a>
...
##### `publishDryRun`<sup>Optional</sup> <a name="publishDryRun" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.publishDryRun"></a>
...
##### `publishTasks`<sup>Optional</sup> <a name="publishTasks" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.publishTasks"></a>
...
##### `releasableCommits`<sup>Optional</sup> <a name="releasableCommits" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.releasableCommits"></a>
...
##### `releaseBranches`<sup>Optional</sup> <a name="releaseBranches" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.releaseBranches"></a>
...
##### ~~`releaseEveryCommit`~~<sup>Optional</sup> <a name="releaseEveryCommit" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.releaseEveryCommit"></a>
...
##### `releaseFailureIssue`<sup>Optional</sup> <a name="releaseFailureIssue" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.releaseFailureIssue"></a>
...
##### `releaseFailureIssueLabel`<sup>Optional</sup> <a name="releaseFailureIssueLabel" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.releaseFailureIssueLabel"></a>
...
##### ~~`releaseSchedule`~~<sup>Optional</sup> <a name="releaseSchedule" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.releaseSchedule"></a>
...
##### `releaseTagPrefix`<sup>Optional</sup> <a name="releaseTagPrefix" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.releaseTagPrefix"></a>
...
##### `releaseTrigger`<sup>Optional</sup> <a name="releaseTrigger" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.releaseTrigger"></a>
...
##### `releaseWorkflowName`<sup>Optional</sup> <a name="releaseWorkflowName" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.releaseWorkflowName"></a>
...
##### `releaseWorkflowSetupSteps`<sup>Optional</sup> <a name="releaseWorkflowSetupSteps" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.releaseWorkflowSetupSteps"></a>
...
##### `versionrcOptions`<sup>Optional</sup> <a name="versionrcOptions" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.versionrcOptions"></a>
...
##### `workflowContainerImage`<sup>Optional</sup> <a name="workflowContainerImage" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.workflowContainerImage"></a>
...
##### `workflowRunsOn`<sup>Optional</sup> <a name="workflowRunsOn" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.workflowRunsOn"></a>
...
##### `workflowRunsOnGroup`<sup>Optional</sup> <a name="workflowRunsOnGroup" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.workflowRunsOnGroup"></a>
...
##### `defaultReleaseBranch`<sup>Required</sup> <a name="defaultReleaseBranch" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.defaultReleaseBranch"></a>
...
##### `artifactsDirectory`<sup>Optional</sup> <a name="artifactsDirectory" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.artifactsDirectory"></a>
...
##### `autoApproveUpgrades`<sup>Optional</sup> <a name="autoApproveUpgrades" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.autoApproveUpgrades"></a>
...
##### `buildWorkflow`<sup>Optional</sup> <a name="buildWorkflow" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.buildWorkflow"></a>
...
##### `buildWorkflowTriggers`<sup>Optional</sup> <a name="buildWorkflowTriggers" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.buildWorkflowTriggers"></a>
...
##### `bundlerOptions`<sup>Optional</sup> <a name="bundlerOptions" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.bundlerOptions"></a>
...
##### `checkLicenses`<sup>Optional</sup> <a name="checkLicenses" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.checkLicenses"></a>
...
##### `codeCov`<sup>Optional</sup> <a name="codeCov" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.codeCov"></a>
...
##### `codeCovTokenSecret`<sup>Optional</sup> <a name="codeCovTokenSecret" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.codeCovTokenSecret"></a>
...
##### `copyrightOwner`<sup>Optional</sup> <a name="copyrightOwner" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.copyrightOwner"></a>
...
##### `copyrightPeriod`<sup>Optional</sup> <a name="copyrightPeriod" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.copyrightPeriod"></a>
...
##### `dependabot`<sup>Optional</sup> <a name="dependabot" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.dependabot"></a>
...
##### `dependabotOptions`<sup>Optional</sup> <a name="dependabotOptions" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.dependabotOptions"></a>
...
##### `depsUpgrade`<sup>Optional</sup> <a name="depsUpgrade" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.depsUpgrade"></a>
...
##### `depsUpgradeOptions`<sup>Optional</sup> <a name="depsUpgradeOptions" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.depsUpgradeOptions"></a>
...
##### `gitignore`<sup>Optional</sup> <a name="gitignore" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.gitignore"></a>
...
##### `jest`<sup>Optional</sup> <a name="jest" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.jest"></a>
...
##### `jestOptions`<sup>Optional</sup> <a name="jestOptions" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.jestOptions"></a>
...
##### `mutableBuild`<sup>Optional</sup> <a name="mutableBuild" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.mutableBuild"></a>
...
##### ~~`npmignore`~~<sup>Optional</sup> <a name="npmignore" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.npmignore"></a>
...
##### `npmignoreEnabled`<sup>Optional</sup> <a name="npmignoreEnabled" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.npmignoreEnabled"></a>
...
##### `npmIgnoreOptions`<sup>Optional</sup> <a name="npmIgnoreOptions" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.npmIgnoreOptions"></a>
...
##### `package`<sup>Optional</sup> <a name="package" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.package"></a>
...
##### `prettier`<sup>Optional</sup> <a name="prettier" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.prettier"></a>
...
##### `prettierOptions`<sup>Optional</sup> <a name="prettierOptions" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.prettierOptions"></a>
...
##### `projenDevDependency`<sup>Optional</sup> <a name="projenDevDependency" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.projenDevDependency"></a>
...
##### `projenrcJs`<sup>Optional</sup> <a name="projenrcJs" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.projenrcJs"></a>
...
##### `projenrcJsOptions`<sup>Optional</sup> <a name="projenrcJsOptions" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.projenrcJsOptions"></a>
...
##### `projenVersion`<sup>Optional</sup> <a name="projenVersion" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.projenVersion"></a>
...
##### `pullRequestTemplate`<sup>Optional</sup> <a name="pullRequestTemplate" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.pullRequestTemplate"></a>
...
##### `pullRequestTemplateContents`<sup>Optional</sup> <a name="pullRequestTemplateContents" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.pullRequestTemplateContents"></a>
...
##### `release`<sup>Optional</sup> <a name="release" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.release"></a>
...
##### `releaseToNpm`<sup>Optional</sup> <a name="releaseToNpm" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.releaseToNpm"></a>
...
##### ~~`releaseWorkflow`~~<sup>Optional</sup> <a name="releaseWorkflow" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.releaseWorkflow"></a>
...
##### `workflowBootstrapSteps`<sup>Optional</sup> <a name="workflowBootstrapSteps" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.workflowBootstrapSteps"></a>
...
##### `workflowGitIdentity`<sup>Optional</sup> <a name="workflowGitIdentity" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.workflowGitIdentity"></a>
...
##### `workflowNodeVersion`<sup>Optional</sup> <a name="workflowNodeVersion" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.workflowNodeVersion"></a>
...
##### `workflowPackageCache`<sup>Optional</sup> <a name="workflowPackageCache" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.workflowPackageCache"></a>
...
##### `disableTsconfig`<sup>Optional</sup> <a name="disableTsconfig" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.disableTsconfig"></a>
...
##### `disableTsconfigDev`<sup>Optional</sup> <a name="disableTsconfigDev" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.disableTsconfigDev"></a>
...
##### `docgen`<sup>Optional</sup> <a name="docgen" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.docgen"></a>
...
##### `docsDirectory`<sup>Optional</sup> <a name="docsDirectory" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.docsDirectory"></a>
...
##### `entrypointTypes`<sup>Optional</sup> <a name="entrypointTypes" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.entrypointTypes"></a>
...
##### `eslint`<sup>Optional</sup> <a name="eslint" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.eslint"></a>
...
##### `eslintOptions`<sup>Optional</sup> <a name="eslintOptions" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.eslintOptions"></a>
...
##### `libdir`<sup>Optional</sup> <a name="libdir" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.libdir"></a>
...
##### `projenrcTs`<sup>Optional</sup> <a name="projenrcTs" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.projenrcTs"></a>
...
##### `projenrcTsOptions`<sup>Optional</sup> <a name="projenrcTsOptions" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.projenrcTsOptions"></a>
...
##### `sampleCode`<sup>Optional</sup> <a name="sampleCode" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.sampleCode"></a>
...
##### `srcdir`<sup>Optional</sup> <a name="srcdir" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.srcdir"></a>
...
##### `testdir`<sup>Optional</sup> <a name="testdir" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.testdir"></a>
...
##### `tsconfig`<sup>Optional</sup> <a name="tsconfig" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.tsconfig"></a>
...
##### `tsconfigDev`<sup>Optional</sup> <a name="tsconfigDev" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.tsconfigDev"></a>
...
##### `tsconfigDevFile`<sup>Optional</sup> <a name="tsconfigDevFile" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.tsconfigDevFile"></a>
...
##### `tsJestOptions`<sup>Optional</sup> <a name="tsJestOptions" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.tsJestOptions"></a>
...
##### `typescriptVersion`<sup>Optional</sup> <a name="typescriptVersion" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.typescriptVersion"></a>
...
##### `buildCommand`<sup>Optional</sup> <a name="buildCommand" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.buildCommand"></a>
...
##### `cdkout`<sup>Optional</sup> <a name="cdkout" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.cdkout"></a>
...
##### `context`<sup>Optional</sup> <a name="context" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.context"></a>
...
##### `featureFlags`<sup>Optional</sup> <a name="featureFlags" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.featureFlags"></a>
...
##### `requireApproval`<sup>Optional</sup> <a name="requireApproval" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.requireApproval"></a>
...
##### `watchExcludes`<sup>Optional</sup> <a name="watchExcludes" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.watchExcludes"></a>
...
##### `watchIncludes`<sup>Optional</sup> <a name="watchIncludes" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.watchIncludes"></a>
...
##### `cdkVersion`<sup>Required</sup> <a name="cdkVersion" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.cdkVersion"></a>
...
##### ~~`cdkAssert`~~<sup>Optional</sup> <a name="cdkAssert" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.cdkAssert"></a>
...
##### `cdkAssertions`<sup>Optional</sup> <a name="cdkAssertions" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.cdkAssertions"></a>
...
##### ~~`cdkDependencies`~~<sup>Optional</sup> <a name="cdkDependencies" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.cdkDependencies"></a>
...
##### ~~`cdkDependenciesAsDeps`~~<sup>Optional</sup> <a name="cdkDependenciesAsDeps" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.cdkDependenciesAsDeps"></a>
...
##### ~~`cdkTestDependencies`~~<sup>Optional</sup> <a name="cdkTestDependencies" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.cdkTestDependencies"></a>
...
##### `cdkVersionPinning`<sup>Optional</sup> <a name="cdkVersionPinning" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.cdkVersionPinning"></a>
...
##### `constructsVersion`<sup>Optional</sup> <a name="constructsVersion" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.constructsVersion"></a>
...
##### `appEntrypoint`<sup>Optional</sup> <a name="appEntrypoint" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.appEntrypoint"></a>
...
##### `edgeLambdaAutoDiscover`<sup>Optional</sup> <a name="edgeLambdaAutoDiscover" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.edgeLambdaAutoDiscover"></a>
...
##### `experimentalIntegRunner`<sup>Optional</sup> <a name="experimentalIntegRunner" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.experimentalIntegRunner"></a>
...
##### `integrationTestAutoDiscover`<sup>Optional</sup> <a name="integrationTestAutoDiscover" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.integrationTestAutoDiscover"></a>
...
##### `lambdaAutoDiscover`<sup>Optional</sup> <a name="lambdaAutoDiscover" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.lambdaAutoDiscover"></a>
...
##### `lambdaExtensionAutoDiscover`<sup>Optional</sup> <a name="lambdaExtensionAutoDiscover" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.lambdaExtensionAutoDiscover"></a>
...
##### `lambdaOptions`<sup>Optional</sup> <a name="lambdaOptions" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.lambdaOptions"></a>
...
##### `checkActiveDeployment`<sup>Optional</sup> <a name="checkActiveDeployment" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.checkActiveDeployment"></a>
...
##### `deployOptions`<sup>Optional</sup> <a name="deployOptions" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.deployOptions"></a>

```typescript
public readonly deployOptions: DeployOptions;
```

- *Type:* <a href="#awscdk-template-app-ts.DeployOptions">DeployOptions</a>
...
##### `generateNvmrc`<sup>Optional</sup> <a name="generateNvmrc" id="awscdk-template-app-ts.AwsCdkTemplateTypeScriptAppOptions.property.generateNvmrc"></a>
...
### AWSCredentials <a name="AWSCredentials" id="awscdk-template-app-ts.AWSCredentials"></a>

#### Initializer <a name="Initializer" id="awscdk-template-app-ts.AWSCredentials.Initializer"></a>

```typescript
import { AWSCredentials } from 'awscdk-template-app-ts'
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#awscdk-template-app-ts.AWSCredentials.property.region">region</a></code> | <code>string</code> | Default AWS region for the account. |
| <code><a href="#awscdk-template-app-ts.AWSCredentials.property.accessKeyIdSecretName">accessKeyIdSecretName</a></code> | <code>string</code> | GitHub Secret name for AWS Access Key Id. |
| <code><a href="#awscdk-template-app-ts.AWSCredentials.property.assumeRoleDurationSeconds">assumeRoleDurationSeconds</a></code> | <code>number</code> | Duration of assume role session. |
| <code><a href="#awscdk-template-app-ts.AWSCredentials.property.roleToAssume">roleToAssume</a></code> | <code>string</code> | ARN of AWS role to be assumed. |
| <code><a href="#awscdk-template-app-ts.AWSCredentials.property.secretAccessKeySecretName">secretAccessKeySecretName</a></code> | <code>string</code> | GitHub Secret name for AWS Secret Access Key. |

---

##### `region`<sup>Required</sup> <a name="region" id="awscdk-template-app-ts.AWSCredentials.property.region"></a>
...
##### `accessKeyIdSecretName`<sup>Optional</sup> <a name="accessKeyIdSecretName" id="awscdk-template-app-ts.AWSCredentials.property.accessKeyIdSecretName"></a>
...
##### `assumeRoleDurationSeconds`<sup>Optional</sup> <a name="assumeRoleDurationSeconds" id="awscdk-template-app-ts.AWSCredentials.property.assumeRoleDurationSeconds"></a>
...
##### `roleToAssume`<sup>Optional</sup> <a name="roleToAssume" id="awscdk-template-app-ts.AWSCredentials.property.roleToAssume"></a>
...
##### `secretAccessKeySecretName`<sup>Optional</sup> <a name="secretAccessKeySecretName" id="awscdk-template-app-ts.AWSCredentials.property.secretAccessKeySecretName"></a>
...
### DeployOptions <a name="DeployOptions" id="awscdk-template-app-ts.DeployOptions"></a>

#### Initializer <a name="Initializer" id="awscdk-template-app-ts.DeployOptions.Initializer"></a>

```typescript
import { DeployOptions } from 'awscdk-template-app-ts'
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#awscdk-template-app-ts.DeployOptions.property.environments">environments</a></code> | <code><a href="#awscdk-template-app-ts.EnvironmentOptions">EnvironmentOptions</a>[]</code> | Environment settings to deploy to. |
| <code><a href="#awscdk-template-app-ts.DeployOptions.property.environmentVariableName">environmentVariableName</a></code> | <code>string</code> | Name of the environment variable used to set the deploy environment name. |
| <code><a href="#awscdk-template-app-ts.DeployOptions.property.method">method</a></code> | <code>string</code> | How to perform the deployment. |
| <code><a href="#awscdk-template-app-ts.DeployOptions.property.npmConfigEnvironment">npmConfigEnvironment</a></code> | <code>string</code> | npm config name to set as the environment name This might be useful in deployment process. |
| <code><a href="#awscdk-template-app-ts.DeployOptions.property.stackPattern">stackPattern</a></code> | <code>string</code> | Regex for stacks to be deployed. |
| <code><a href="#awscdk-template-app-ts.DeployOptions.property.taskToRunPreInstall">taskToRunPreInstall</a></code> | <code>string</code> | task name to run prior to installation in deploy job of workflow if not provided will not add to workflow. |

---

##### `environments`<sup>Required</sup> <a name="environments" id="awscdk-template-app-ts.DeployOptions.property.environments"></a>
...
##### `environmentVariableName`<sup>Optional</sup> <a name="environmentVariableName" id="awscdk-template-app-ts.DeployOptions.property.environmentVariableName"></a>
...
##### `method`<sup>Optional</sup> <a name="method" id="awscdk-template-app-ts.DeployOptions.property.method"></a>
...
##### `npmConfigEnvironment`<sup>Optional</sup> <a name="npmConfigEnvironment" id="awscdk-template-app-ts.DeployOptions.property.npmConfigEnvironment"></a>
...
##### `stackPattern`<sup>Optional</sup> <a name="stackPattern" id="awscdk-template-app-ts.DeployOptions.property.stackPattern"></a>
...
##### `taskToRunPreInstall`<sup>Optional</sup> <a name="taskToRunPreInstall" id="awscdk-template-app-ts.DeployOptions.property.taskToRunPreInstall"></a>
...
### EnvironmentOptions <a name="EnvironmentOptions" id="awscdk-template-app-ts.EnvironmentOptions"></a>

#### Initializer <a name="Initializer" id="awscdk-template-app-ts.EnvironmentOptions.Initializer"></a>

```typescript
import { EnvironmentOptions } from 'awscdk-template-app-ts'
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#awscdk-template-app-ts.EnvironmentOptions.property.awsCredentials">awsCredentials</a></code> | <code><a href="#awscdk-template-app-ts.AWSCredentials">AWSCredentials</a></code> | AWS credential details for deployment. |
| <code><a href="#awscdk-template-app-ts.EnvironmentOptions.property.name">name</a></code> | <code>string</code> | Environment name to deploy to. |
| <code><a href="#awscdk-template-app-ts.EnvironmentOptions.property.postDeployWorkflowScript">postDeployWorkflowScript</a></code> | <code>string</code> | The script/task to run after deployment of the environment in the workflow If not present, the workflow will not execute that. |
| <code><a href="#awscdk-template-app-ts.EnvironmentOptions.property.preDeployWorkflowScript">preDeployWorkflowScript</a></code> | <code>string</code> | The script/task to run before deployment of the environment in the workflow If not present, the workflow will not execute that. |

---

##### `awsCredentials`<sup>Required</sup> <a name="awsCredentials" id="awscdk-template-app-ts.EnvironmentOptions.property.awsCredentials"></a>

```typescript
public readonly awsCredentials: AWSCredentials;
```

- *Type:* <a href="#awscdk-template-app-ts.AWSCredentials">AWSCredentials</a>

AWS credential details for deployment.

---

##### `name`<sup>Required</sup> <a name="name" id="awscdk-template-app-ts.EnvironmentOptions.property.name"></a>
...
##### `postDeployWorkflowScript`<sup>Optional</sup> <a name="postDeployWorkflowScript" id="awscdk-template-app-ts.EnvironmentOptions.property.postDeployWorkflowScript"></a>
...
##### `preDeployWorkflowScript`<sup>Optional</sup> <a name="preDeployWorkflowScript" id="awscdk-template-app-ts.EnvironmentOptions.property.preDeployWorkflowScript"></a>
