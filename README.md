# replace this# Deployable Typescript AWS CDK App Projen Project
...
$ cd my-project
$ git init
$ npx projen new --from awscdk-template-app-ts --projenrc-ts
...
$ cd my-project
$ git init
$ npx projen new --from awscdk-template-app-ts
🤖 Synthesizing project...
...
```
...
### Example
```javascript
const { AwsCdkTemplateTypeScriptApp } = require('awscdk-template-app-ts');

const project = new AwsCdkTemplateTypeScriptApp({
  name: 'my-test-app',
